...
public class BinarySearchTreeTest {
    public static void main(String[] args) {
        // Create an instance of BinarySearchTree to test
        BinarySearchTree binarySearchTree = new BinarySearchTree();

        // Perform 100,000 insertions into the tree
        insert(binarySearchTree);

        // Perform 100,000 searches in the tree
        search(binarySearchTree);
    }

    // Method to perform 100,000 insertions into the BinarySearchTree
    ...
    // Method to perform 100,000 searches in the BinarySearchTree
